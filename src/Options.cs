...
namespace FasterDoors
{
    ...
    public class Options : OptionInterface
    {
        ...
        public static Configurable<int> TransitionSpeed = instance.config.Bind("TransitionSpeed", 110, new ConfigurableInfo(
            "10-100, Around 2x speed. 100-500 very fast",
            new ConfigAcceptableRange<int>(10, 500), "", "Room Transition Speed"));
        #endregion
        ...
        public override void Initialize()
        {
            ...
            AddSlider(TransitionSpeed, (string)TransitionSpeed.info.Tags[0], "10", "500");
        ...
        private void AddTab(ref int tabIndex, string tabName)
        {
            ...
            AddTextLabel("by " + Plugin.AUTHOR, FLabelAlignment.Right);
            DrawTextLabels(ref Tabs[tabIndex]);
